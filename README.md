...
- copy/paste assets fom complete project
...
- replace favicon.icon in public
- resource (favicons)[https://favicon.io/]

## Normalize css and Global Styles

- css in js
- saves times in the setup
- less lines of css
...
- react router and styled omponents right ater
- create pages directory in the sources
- for now Landing.js
